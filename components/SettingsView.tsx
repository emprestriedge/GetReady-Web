...
const SettingsView: React.FC<SettingsViewProps> = ({ config, rules, setRules, spotifyUser, authError, authStatus, setAuthStatus }) => {
  ...
  // BEHAVIOR: Scroll to top on settings sub-page navigation
  useEffect(() => {
    window.scrollTo(0, 0);
  ...
  const handleConnect = async () => {
    ...
    try {
      await SpotifyAuth.loginWithPopup();
    } catch (e: any) {
      setAuthStatus('error');
      Haptics.error();
      alert(e.message);
    ...
    <div className="p-4 animate-in fade-in duration-500 pb-32">
      ...
      <div className="flex flex-col gap-8">
        ...
        <section>
          ...
          <div className="glass-panel-gold rounded-3xl overflow-hidden p-6 flex flex-col gap-5">
               ...
               <div className="flex flex-col gap-4">
                 ...
                 >
                   ...
                   <div className="relative z-10 flex-1">
                     ...
                     <p className="text-xs text-white/60 font-medium">PKCE Flow Authorization</p>
                   </div>
