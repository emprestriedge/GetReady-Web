...
const NowPlayingStrip: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-24 left-4 right-4 z-[60] animate-in slide-in-from-bottom-4 duration-500">
      <div className="bg-black/60 backdrop-blur-3xl border border-white/10 rounded-[28px] p-3 flex items-center gap-3 shadow-2xl">
        <div className="w-12 h-12 rounded-xl overflow-hidden shrink-0 border border-white/5 relative">
          <img src={imageUrl} className="w-full h-full object-cover" alt="Art" />
          {!isPlaying && <div className="absolute inset-0 bg-black/40 flex items-center justify-center"><div className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" /></div>}
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 mt-0.5">
            <span className="text-[11px] text-zinc-500 font-medium truncate max-w-[60%]">
